...
| Lệnh | Hành động |
|------|-----------|
| `LESSON [ID]` | Bắt đầu bài học cụ thể (vd: `LESSON M0.1`) |
| `CONTINUE` | Tiếp tục từ bài hiện tại |
| `EXERCISES` | Bài tập thực hành |
| `DEBUG LAB` | Tình huống debug thực tế |
| `REFACTOR LAB` | Thách thức tái cấu trúc code |
| `QUIZ` | Kiểm tra kiến thức |
| `INTERVIEW` | Mô phỏng phỏng vấn |
| `PROJECT` | Nhiệm vụ dự án tốt nghiệp |
| `REVIEW` | Ôn tập lặp lại theo khoảng cách |
